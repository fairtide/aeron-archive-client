...
ChannelUri ChannelUri::parse(const std::string & str) {
    ...
    {
        throw aeron::util::IllegalArgumentException("Aeron URIs must start with 'aeron:', found: '" + str + "'", SOURCEINFO);
    }
    else
    {
    ...
    while (position < str.size())
    {
        ...
        case State::MEDIA:
            ...
            case ':':
                throw aeron::util::IllegalArgumentException("encountered ':' within media definition", SOURCEINFO);
        ...
        default:
            throw aeron::util::IllegalStateException("unexpected state=" + std::to_string(static_cast<int>(state)), SOURCEINFO);
        }
    }
    ...
    default:
        throw aeron::util::IllegalArgumentException("no more input found, state=" + std::to_string(static_cast<int>(state)), SOURCEINFO);
    }
